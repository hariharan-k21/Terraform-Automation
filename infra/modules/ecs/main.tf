resource "aws_kms_key" "hariharan-k21" {
  description = var.kms_key_description
}

resource "aws_cloudwatch_log_group" "hariharan-k21" {
  name              = var.log_group_name
  retention_in_days = 14
}

resource "aws_ecs_cluster" "hariharan-k21" {
...
resource "aws_ecs_task_definition" "hariharan-k21" {
...
resource "aws_ecs_service" "hariharan-k21" {
  ...
  depends_on = [aws_ecs_cluster.hariharan-k21]  
}
